...
<script type="text/javascript">
    ...
    var columns = [[
        ...
        {
            field: "studentShaungyue",
            title: "爽约次数",
            width: 120,
            align: "center",
        },
        {
            field: "studentTimeCount",
            title: "练车最高次数",
            width: 120,
            align: "center",
        },
...
<div class="easyui-window" title="修改学生预约次数，考试项目" id="editstudent"
    ...
    <div region="center" style="overflow:auto;padding:5px;" border="false">
        <form id="editForm">
            <table class="table-edit" width="80%" align="center">
                ...
                <tr>
                    <td>身份证号</td>
                    <td><input type="text" class="menu-active-disabled" name="studentIdcard"
                               required="true"/></td>
                </tr>
                <tr>
                    ...
                    <td><input type="text" class="easyui-validatebox"
                               name="studentTimeCount"/></td>
                </tr>
                <tr>

                    <td>学生状态</td>
                    <td><input type="text" class="easyui-validatebox"
                               name="studentSatus"/></td>
                        ...
                        $("#edit").click(function () {
                            ...
                            if (v) {
                                ...
                                $.post("${pageContext.request.contextPath}/studentedit", formdata, function (data) {
                                    ...
                                    if (data == "true") {
                                        alert("修改成功");
                                        window.location.href = "${pageContext.request.contextPath}/ds/lookusertime";
                                    } else {
                                        alert("修改失败");
                                        window.location.href = "${pageContext.request.contextPath}/ds/lookusertime";
                                    }
                    ...
                    $(function () {
                        ...
                        $("#save").click(function () {
                            ...
                            if (v) {
                                ...
                                $.post("${pageContext.request.contextPath}/studentadd", formdata, function (data) {
                                    //todo
